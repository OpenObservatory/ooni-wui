        ...
        <div className="circumvention-strategy">
          ...
          <p>You can find instructions on how to change your DNS resolver to the
            Google DNS resolver through the following URL: <a
              href="https://developers.google.com/speed/public-dns/docs/using">https://developers.google.com/speed/public-dns/docs/using</a>
          </p>
        </div>
        }
        <div className="circumvention-strategy">
          ...
          <p>
            ...
            <a href="https://github.com/TheTorProject/gettorbrowser/"> https://github.com/TheTorProject/gettorbrowser/</a>
          </p>
        </div>

    ...
    <div className='container'>
      <div className='row text-xs-center'>
        ...
        <p>Anyone monitoring your internet activity (e.g. ISP, government, employer) can know that
          you are running ooniprobe (even though OONI tries to make this hard).</p>

        <p>When testing websites for censorship, you will connect to and download data from provocative or
        ...
        <p>Unless you configure your settings otherwise, all data collected from your tests will by default be
          ...
          tries to prevent this from happening).</p>
        <p>The use of ooniprobe could be viewed as a form of espionage, regardless of the laws in your country.
        </p>
        <p>
        To our knowledge, no ooniprobe user has ever faced consequences from the use of our platform.
          ...
          penalties. <a href='https://ooni.torproject.org/about/risks'>Learn more here</a>.</p>
        <p>We encourage you to consult with a lawyer prior to installing and running ooniprobe.</p>
      </div>

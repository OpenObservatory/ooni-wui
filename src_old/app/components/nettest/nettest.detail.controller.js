var httpInvalidRequestLineDescription = require('./directives/http-invalid-request-line.md');
var httpHeaderFieldManipulationDescription = require('./directives/http-header-field-manipulation.md');
var webConnectivityDescription = require('./directives/web-connectivity.md');
